...
🔗 [Acesse meu portfólio online](https://nexuslogisticadev-creator.github.io/PortifolioAdiel/)

Este repositório reúne projetos desenvolvidos por Adiel Alves, incluindo automações, painéis, bots e soluções para logística e delivery.
...
Para detalhes completos, acesse o README do projeto na pasta `BOT-CONTROL` ou [diretamente aqui](https://github.com/nexuslogisticadev-creator/BOT-CONTROL).
